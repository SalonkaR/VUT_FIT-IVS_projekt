...
class LongSolve_exprTests(unittest.TestCase):
    def test_solve_expr_long1(self):
        self.assertAlmostEqual(solve_expr("fac5 + 4 - 4 * 4 / 4 - abs3 - abs-3.4 + 2√4 + 3√2 + 2.2^2.2 -2^-4"), 122.4641168)
    def test_solve_expr_long2(self):
        self.assertAlmostEqual(solve_expr("6√64 * 1.5 - 0.0002 / 2^3 - fac0"), 1.999975)
    def test_solve_expr_long3(self):
        self.assertEqual(solve_expr("fac10 + 5 - -90 / 3 * 2^4 - 2√256 + abs-2"), 3629271, "Ma byt 3629271")
